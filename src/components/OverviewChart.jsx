...
import { useGetAggregatedBookingDataByDayQuery, useGetAggregatedBookingDataByMonthQuery } from "state/api";
...
const OverviewChart = ({ isDashboard = false, view }) => {
  ...
  const [totalSalesLine, totalUnitsLine] = useMemo(() => {
    ...
    Object.values(dataPerMonth).reduce(
      (acc, { month, total_booking_amount, total_customers }) => {
        const curSales = acc.sales + total_booking_amount;
        const curUnits = acc.units + total_customers;
